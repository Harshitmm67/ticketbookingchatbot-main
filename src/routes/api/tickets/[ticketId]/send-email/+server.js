...
async function createPDF(person, numberOfTickets, date, ticketId) {
	...
	page.drawText('OCBTS Panel, Haryana', {
		x: 30,
		y: height - 200,
		size: fontSize + 4,
		font: font,
	...
	page.drawText(`Museum Address: Kurushetra`, {
		x: 30,
		y: height - 370,
		size: fontSize,
		font: font,
	...
	page.drawText(`Contact: +91 99999-88888`, {
		x: 30,
		y: height - 400,
		size: fontSize,
		font: font,
...
export async function POST({ request }) {
	...
	try {
		...
		const mailOptions = {
			from: 'OCBTS Booking Team <transactionalerts@yahoo.com>', // Sender address
			to: email,
			subject: 'Your Ticket Confirmation for Panorma, Kurushetra',
			html: `
<!DOCTYPE html>
<html>
<head>
...
<body>
  <div class="container">
    ...
    <div class="content">
      <h2>Dear ${person},</h2>
      <p>Thank you for booking your tickets to visit the Panorma Museum in Kurushetra. We are thrilled to have you join us for a memorable experience.</p>
    ...
    <div class="footer">
      <p>&copy; 2025 OCBTS SYSTEM. All rights reserved.</p>
    </div>
  </div>
</body>
</html>
