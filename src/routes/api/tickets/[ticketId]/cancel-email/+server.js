...
export async function POST({ request }) {
	...
	try {
		...
		const mailOptions = {
			from: 'OCBTS Cancellation Team <transactionalerts@yahoo.com>', // Sender address
			to: email,
			subject: 'Your Ticket Cancellation for OCBTS, Haryana',
			html: `
<!DOCTYPE html>
<html>
<head>
...
<body>
  <div class="container">
    ...
    <div class="content">
      <h2>Dear ${person},</h2>
      <p>We regret to inform you that your booking to visit the Panorma in Kurushetra has been cancelled as per your request.</p>
      ...
      <p>If you have any questions or need further assistance, please contact us at <strong>+91 99999-88888</strong> or reply to this email.</p>
